...
const CART_KEY = 'custocerto_cart_v2';
const HISTORY_KEY = 'custocerto_history_v2';
const BUDGET_KEY = 'custocerto_budget_v2';
...
export function getStoredHistory(): ShoppingSession[] {
  try {
...
export function saveStoredHistory(history: ShoppingSession[]): void {
  try {
...
export function saveStoredBudget(limit: number): void {
  try {
