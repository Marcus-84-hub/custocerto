...
/**
 * Normalizes package size into base units (kg, L, un, rolo, etc.)
 */
...
/**
 * Calculates unit price per base unit (e.g. per 1kg, per 1L, per 1 un)
 */
...
export interface ComparisonResult {
  ...
  unitSavings: number; // Absolute savings per base unit
  percentageSavings: number; // Percentage savings of best vs worst
...
export function evaluateComparison(
  ...
  // Map and calculate unit price for each item
  ...
  // Sort by calculated unit price ascending
...
/**
 * Calculates inflation percentage between current price and previous price
 */
